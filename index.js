...
client.on('ready', () => {
  client.user.setGame(` ZinoDz #4272 .`,'');
  console.log('---------------');
  console.log('AG BOT Is Online')
  console.log('---------------')
});
...
if (message.content === '/help') {
         let embed = new Discord.RichEmbed()
.setThumbnail(message.author.avatarURL)    
      .addField("** مبرمج البوت :wrench: **","**@ZinoDzYT**")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
});
...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`OG BOT- Script By : ZinoDzYT`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : ZinoDzYT ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(` ON ${client.guilds.size} with ZinoDzYT - Prefix *help`,"https://www.twitch.tv/zinodz05")
client.user.setStatus("dnd")
});
client.on("guildCreate", guild => {
  console.log(` Join Bot Of Server ${guild.name} Owner Of Server ${ZinoDzYT}!`)
});
const secreT = [
...
client.login("NDY2MjAyMzIzMTYxNzEwNTky.DiYoRQ.2Vb9po1OEwPmU2Z0lWiXoPGNxQ0");